...
With the complete data from the previous ten years since 2014, linear regression models were built for each variable of interest. Neumann's model's for regions in and out of conflict defined the  variable which would be of interest for this research. Each regression model was built with the goal of achieving the most parsimonium model from the other variables in the data. Before the regression models were build and reduced, the data set required certain variables utilized by Neumann's research be developed from the complete imputed data. Van Buuren stressed the importance of developing imputations before any additional variables are generated (CITE Van Buuren).  
