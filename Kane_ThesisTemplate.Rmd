...
```{r scear1Arabconficts, echo=FALSE, fig.cap="\\label{plot:Arabscen1Conflicts}Arab Region's Scenario 1 Alternative Futures' Avearge Yearly Conflicts", cache=TRUE, fig.width = 5, fig.height = 4, out.height="35%"}
...
```{r scenar1SEconficts, echo=FALSE, fig.cap="\\label{plot:SEAsiaConflictscenar1}Southeast Asia Region's Scenario 1 Alternative Futures' Avearged Yearly Conflicts", fig.width = 5, fig.height = 4, out.height="35%"}
...
```{r scenar2SEconficts, echo=FALSE, fig.cap="\\label{plot:SEAsiaConflictscenar2}Southeast Asia Region's Scenario 2 Alternative Futures' Avearged Yearly Conflicts", fig.width = 5, fig.height = 4, out.height="35%"}
...
```{r scenar3SEconficts, echo=FALSE, fig.cap="\\label{plot:SEAsiaConflictscenar3}Southeast Asia Region's Scenario 3 Alternative Futures' Avearged Yearly Conflicts", fig.width = 5, fig.height = 4, out.height="35%",eval=TRUE}
