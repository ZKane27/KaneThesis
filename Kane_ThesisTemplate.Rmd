...
_Non-parametric regression for space–time forecasting under missing data_ analyzes real time spatio-temporal datasets experiencing missingness due to long periods of unobservation sensors and tries to forecast the future unit journey time values of road links in central London, UK using two non-parametric regression models: kernel regression and K-nearest neighbours. 
