...
kable(x, align = "c", "latex", booktabs = T, caption = "\\label{tab:ArabSummary}Arab Region Average Alternate Futures' Performances") %>%
...
kable(y, align = "c", "latex", booktabs = T,) %>%
...
kable(x, align = "c", "latex", booktabs = T, caption = "\\label{tab:SEAsiaSummary}SE Asia Region Average Alternate Futures' Performances") %>%
  add_header_above(c(" ", "FROT[note]" = 3, "PROT[note]" = 1, "FCL[note]" = 3, "PCL[note]" = 1)) %>%
  add_footnote(c("Future average rate of transitions",
                 "Past ten years rate of transitions",
                 "Future conflict likelihood",
