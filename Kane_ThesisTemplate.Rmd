...
This study is based on XXXX underlying assumptions. The first assumption, similiar to other conflict prediction research, is that the data analyzed is accurate and describes the commonalities between countries and their conflicts. The second assumption is that the variables identified as significant for Neumann's conflict prediction models are the only relevant variables for predicting conflict during the duration of future years. Next, this study assumes 
